...
public:
    ...
    void timeManagementMenu() {
        ...
        do {
            ...
            cout << "3. Manage Leave Balances" << endl;
    ...
    void clientRelationshipManagementMenu() {
        ...
        do {
            ...
            cout << "3. Track Client-Specific Projects or Contacts" << endl;
            cout << "4. View All Clients" << endl; // Added for completeness
            cout << "5. Back to Main Menu" << endl;
            cout << "Enter your choice: ";
            cin >> choice;
    ...
    void projectManagementMenu() {
        ...
        do {
            ...
            cout << "3. Track Project Deadlines" << endl;
            cout << "4. View Employees Assigned to Projects" << endl;
            cout << "5. Back to Main Menu" << endl;
            cout << "Enter your choice: ";
            cin >> choice;
    ...
    void businessIntelligenceMenu() {
        ...
        do {
            ...
            cout << "3. Average, Max, and Min Salaries" << endl;
